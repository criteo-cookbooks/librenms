...
cron 'discovery all' do
  ...
  only_if { node.normal['librenms']['cron']['discovery_all']['enabled'] = "true" }
end
...
cron 'discover new' do
  ...
  user librenms_username
  only_if { node.normal['librenms']['cron']['discovery_new']['enabled'] = "true" }
end
...
cron 'poller wrapper' do
  ...
  user librenms_username
  only_if { node.normal['librenms']['cron']['poller']['enabled'] = "true" }
end
...
cron 'daily' do
  ...
  user librenms_username
  only_if { node.normal['librenms']['cron']['daily']['enabled'] = "true" }
end
...
cron 'alerts' do
  ...
  user librenms_username
  only_if { node.normal['librenms']['cron']['alerts']['enabled'] = "true" }
end
...
cron 'poll billing' do
  ...
  user librenms_username
  only_if { node.normal['librenms']['cron']['poll-billing']['enabled'] = "true" }
end
...
cron 'billing calculate' do
  ...
  user librenms_username
  only_if { node.normal['librenms']['cron']['billing-calculate']['enabled'] = "true" }
end
...
cron 'check services' do
  ...
  user librenms_username
  only_if { node.normal['librenms']['cron']['check']['enabled'] = "true" }
end
